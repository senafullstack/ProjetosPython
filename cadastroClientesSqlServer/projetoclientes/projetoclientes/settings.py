...
SECRET_KEY = 'django-insecure-dqdr@nq=+&vbii)-05%7m)4f8nrv4=cqt=igqs#xs=fz3rwazf'
...
ROOT_URLCONF = 'projetoclientes.urls'
...
WSGI_APPLICATION = 'projetoclientes.wsgi.application'
